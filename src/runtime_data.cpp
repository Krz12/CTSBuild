...
namespace runtime_data {
    chrono::time_point<chrono::high_resolution_clock> __last_time = chrono::high_resolution_clock::now(), __current_time = chrono::high_resolution_clock::now(), __last_time_fps = chrono::high_resolution_clock::now();
    ...
    void update()
    {
        __current_time = chrono::high_resolution_clock::now();
